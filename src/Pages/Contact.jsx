              ...
              <div className="space-y-6">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@barenexus.com" className="text-lg font-semibold text-gray-900">
                      info@barenexus.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <a href="tel:+917818835004" className="text-lg font-semibold text-gray-900">
                      +91 7818835004
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <a href="https://www.linkedin.com/company/barenexus/" className="text-lg font-semibold text-gray-900">
                      @BareNexus
                    </a>
                  </div>
                </div>
